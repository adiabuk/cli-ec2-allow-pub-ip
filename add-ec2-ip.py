...
class WhatIsMyIpRetriever(object):
    ...
    def retrievePublicIp():
        ...
        return urllib2.urlopen(urllib2.Request("http://automation.whatismyip.com/n09230945.asp",
                                               None, headers)).read()
...
class AgentGatechIpRetriever(object):
    ...
    def retrievePublicIp():
        headers = {'User-Agent' : 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:12.0) Gecko/20100101 Firefox/12.0'}
        return urllib2.urlopen(urllib2.Request("http://agentgatech.appspot.com/",
                               None, headers)).read()
